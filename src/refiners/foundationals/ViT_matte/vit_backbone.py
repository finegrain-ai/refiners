...
from refiners.fluxion.utils import interpolate, pad
...
class PositionalEncoder(fl.Residual):
    ...
    def get_abs_pos(self, x: Tensor) -> Tensor:
        ...
        Args:
            x (Tensor): absolute positional embeddings with (1, num_position, C).

        Returns:
            Absolute positional embeddings after processing with shape (1, patch_size, patch_size, C)
        """
